...
module.exports = [
  ...
  { method: "GET", path: "/showcomments/{_id}", config: Pois.showComments },
  { method: "POST", path: "/makecomment", config: Pois.makeComment },
  { method: "GET", path: "/deletecomment/{_id}", config: Pois.deleteComment },
